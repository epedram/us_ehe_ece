...
### Session 2C - Exploring the aggregate impacts of extreme events
...
```{r}
ece_daily_raster_22Jan03 <- rast(file.path(daily_data_dir, "D2022-01-03_S426_T002_idw_ece_unified_grid.tif"))
plot(ece_daily_raster_22Jan03, col = "blue")
plot(us_states[2], add = T, col = NA)
```

## Idenfitying an event boundaries
