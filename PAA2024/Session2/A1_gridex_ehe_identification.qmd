...
Here's a list of R packages we'll need for exploring spatial data in this session. These are already pre-installed on our Posit Cloud instances, so all we need to do is load them using the first code chunk.
...
[GridEX Naming Convention](https://docs.google.com/spreadsheets/d/1N73SnxaKX-0x1m5EM5WhXkWj1NASqk1QTfkjfmxofRw "GridEX Naming Convention")
